    ...
    <footer className="w-full border-t bg-background">
      ...
      <div className="border-t">
        <div className="container mx-auto flex max-w-screen-2xl flex-col items-center justify-between gap-2 px-4 py-4 sm:flex-row">
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Go Nilgris. All rights reserved.</p>
          <p className="text-sm text-muted-foreground">A GoNilgris Tourism Venture</p>
        </div>
      </div>
    </footer>
  );
